        ...
        <>
            <section className="flex flex-row">
                <div className="flex flex-1 flex-col justify-center items-center">
                    ...
                    <button className="py-5 px-10 bg-purple-950 text-white my-10 rounded-full shadow-lg shadow-indigo-500/50" onClick={openModel}>Start the Quiz</button>
                </div>
            ...
            <CustomModal ref={dialog} >
                <div className="modal-header py-5 px-5 relative">
                    <span className="text-black absolute top-0 right-0 p-5 cursor-pointer" onClick={closeModel}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
                        </svg>
                    </span>
                    <h2 className="text-3xl font-bold text-center">Consent to electronic delivery & terms and conditions of use</h2>
                </div>
                <div className="modal-content py-8 px-5">
                    <p className="py-2">The allocations provided are based on generally accepted investment principles. There's no guarantee, however, that any particular asset allocation or combination of investments will meet your objectives. All investments involve risks, and fluctuations in the financial markets and other factors may cause the value of your account to decline. You should consider all of your options carefully before investing. The investor questionnaire is provided to you free of charge. It doesn't provide comprehensive investment or financial advice. Vanguard isn't responsible for reviewing your financial situation or updating the suggestions contained herein.</p>
                    <p className="py-2">By selecting Accept, you agree to the terms outlined on this page.</p>
                    <p className="py-2">Duration of election & consent Your consent applies only to this particular request. If you request additional information, you may be required to consent to electronic delivery again.</p>
                    <h3 className="py-2 font-semibold">Costs & risks</h3>
                    <p className="py-2">Vanguard doesn't charge you a fee to use our website, but you could incur expenses from an internet service provider when you access information online. Also, be aware that your internet service provider may occasionally experience system failure, and hyperlinks to documents may not function properly.</p>
                </div>
                <div className="modal-footer flex items-center justify-center">
                    <button className="mx-5 py-5 px-10 bg-red-700 text-white my-10 rounded-full shadow-lg shadow-indigo-500/50">Accept</button>
                    <button className="mx-5 py-5 px-10 bg-transparent text-black my-10 border-solid border-3 border-black rounded-full shadow-lg shadow-indigo-500/50" onClick={closeModel}>Don't Accept</button>
                </div>
            </CustomModal>
            <Disclaimer>
