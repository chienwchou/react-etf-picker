    ...
    <main className="flex flex-col">
      <section className="flex flex-col bg-purple-200 p-8">
        <div className="flex flex-col items-center">
          <h1 className="font-bold text-4xl py-4">
            Choose the right ETFs for your portfolio
          </h1>
          <p className="font-semibold">
            The ETF picker enables you to refine the ETF Universe to a subset of
            ETFs that fit your investment goal.
          </p>
        </div>
      ...
      <section>
        <div className="flex p-8">
          ...
          <div className="flex flex-1 flex-col text-center justify-center">
            ...
            <p className="font-semibold">
              Calculate your total return based on your ETF portfolio.
            </p>
            <div className="p-8">
      ...
      <section className="flex flex-col p-8">
        <div className="flex flex-col items-center p-10 bg-purple-200 rounded-3xl">
          ...
          <button className="py-5 px-10 bg-purple-950 text-white my-10 rounded-full shadow-lg shadow-indigo-500/50">
            Sign up
          </button>
        </div>
      </section>
      <section className="flex flex-col py-5 px-10">
        <p>
          Commissions, fees and expenses may be associated with investment
          funds. Read a fund’s prospectus or offering memorandum and speak to an
          advisor before investing. Funds are not guaranteed, their values
          change frequently and investors may experience a gain or loss. Past
          performance may not be repeated. Read our privacy policy. By using or
          logging in to this website, you consent to the use of cookies as
          described in our privacy policy. Mutual funds and ETFs displayed are
          only qualified for sale in the provinces and territories of Canada and
          United. 88747-v2023619
        </p>
      </section>
    </main>
  );
